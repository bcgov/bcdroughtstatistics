...
An html version of the drought statistics package can be generated for a specific natural resource management region in BC using either drought_stats_wc() or drought_stats_to(). 
...
drought_stats_wc(basin = "West Coast Natural Resource Region")
```
