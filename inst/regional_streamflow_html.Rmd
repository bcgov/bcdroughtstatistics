...
drought <- suppressWarnings(
  suppressMessages(
    esri2sf::esri2sf("https://services6.arcgis.com/ubm4tcTYICKBpist/ArcGIS/rest/services/British_Columbia_Drought_Levels_View/FeatureServer/1", where = "DroughtLevel >= 0", geomType = "esriGeometryPolygon") %>%
