  ...
  basemap %>%
    ...
    addCircleMarkers(data = interactive_data,
                     ...
                     popup = paste0(interactive_data$`Station.Name`,", ", table_out$`ID`, "<br>",
                                    ...
                                    "Percentile Category: ", interactive_data$pct_bin_7day, "<br>",
                                    "<a href=\"", "https://wateroffice.ec.gc.ca/report/real_time_e.html?stn=", table_out$`ID`, "\" target='_blank'>Link to realtime WSC website (new tab)</a>"),
    ...
    addCircleMarkers(data = interactive_data,
                     ...
                     popup = paste0(interactive_data$`Station.Name`,", ", table_out$`ID`, "<br>",
                                    ...
                                    "Percentile = ", round(interactive_data$Percentile...Last.24.Hour.Q, digits = 0), "<br>", 
                                    "Percentile Category: ", interactive_data$pct_bin_24hours, "<br>",
                                    "<a href=\"", "https://wateroffice.ec.gc.ca/report/real_time_e.html?stn=", table_out$`ID`, "\" target='_blank'>Link to realtime WSC website (new tab)</a>"),
                     label = ~paste0(interactive_data$`Station.Name`,", ", table_out$`ID`, " ", interactive_data$pct_bin_24hours),
  ...
  basemap %>%
    ...
    addCircleMarkers(data = interactive_data_10,
                     ...
                     popup = paste0(interactive_data_10$`Station.Name`,", ", interactive_data_10$`ID`, "<br>",
                                    ...
                                    "Percentile Category: ", interactive_data_10$MAD_bin, "<br>",
                                    "<a href=\"", "https://wateroffice.ec.gc.ca/report/real_time_e.html?stn=", interactive_data_10$`ID`, "\" target='_blank'>Link to realtime WSC website (new tab)</a>"), 
  ...
  temp_plot_1 <-  basemap %>%
    ...
    addCircleMarkers(data = interactive_data,
                     ...
                     popup = paste0(interactive_data$`Station.Name`,", ", interactive_data$`ID`, "<br>",
                                    ...
                                    ifelse(nchar(interactive_data$`ID`)==7,
                                           paste0("<a href=\"", "https://wateroffice.ec.gc.ca/report/real_time_e.html?stn=", 
                                                  interactive_data$`ID`, "\" target='_blank'>Link to realtime WSC website (new tab)</a>"),
    ...
    addCircleMarkers(data = interactive_data_20,
                     ...
                     popup = paste0(interactive_data_20$`Station.Name`,", ", interactive_data_20$`ID`, "<br>",
                                    ...
                                    ifelse(nchar(interactive_data_20$`ID`)==7,
                                           paste0("<a href=\"", "https://wateroffice.ec.gc.ca/report/real_time_e.html?stn=", 
                                                  interactive_data_20$`ID`, "\" target='_blank'>Link to realtime WSC website (new tab)</a>"),
                                           paste0("<a href=\"", "https://aqrt.nrs.gov.bc.ca/Data/DataSet/Chart/Location/", 
                                                  interactive_data_20$`ID`, 
                                                  "/DataSet/TW/Telemetry/Interval/Latest", 
                                                  "\" target='_blank'>Link to realtime BC website (new tab)</a>"))), 
    ...
    addCircleMarkers(data = interactive_data_23,
                     ...
                     popup = paste0(interactive_data_23$`Station.Name`,", ", interactive_data_23$`ID`, "<br>",
                                    ...
                                    ifelse(nchar(interactive_data_23$`ID`)==7,
                                           paste0("<a href=\"", "https://wateroffice.ec.gc.ca/report/real_time_e.html?stn=", 
                                                  interactive_data_23$`ID`, "\" target='_blank'>Link to realtime WSC website (new tab)</a>"),
                                           paste0("<a href=\"", "https://aqrt.nrs.gov.bc.ca/Data/DataSet/Chart/Location/", 
                                                  interactive_data_23$`ID`, 
                                                  "/DataSet/TW/Telemetry/Interval/Latest", 
                                                  "\" target='_blank'>Link to realtime BC website (new tab)</a>"))),
    ...
    temp_plot_2 <- temp_plot_1 %>%
      addCircleMarkers(data = interactive_data_max23,
                       ...
                       popup = paste0(interactive_data_max23$`Station.Name`,", ", interactive_data_max23$`ID`, "<br>",
                                      ...
                                      ifelse(nchar(interactive_data_max23$`ID`)==7,
                                             paste0("<a href=\"", "https://wateroffice.ec.gc.ca/report/real_time_e.html?stn=", 
                                                    interactive_data_max23$`ID`, "\" target='_blank'>Link to realtime WSC website (new tab)</a>"),
                                             paste0("<a href=\"", "https://aqrt.nrs.gov.bc.ca/Data/DataSet/Chart/Location/", 
                                                    interactive_data_max23$`ID`, 
                                                    "/DataSet/TW/Telemetry/Interval/Latest", 
                                                    "\" target='_blank'>Link to realtime BC website (new tab)</a>"))),
