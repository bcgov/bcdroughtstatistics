...
<script>
   $(document).ready(function() {
     $head = $('#header');
     $head.prepend('<img src=\"C:/Users/AJOLLYMO/RProjects/bcdroughtstatistics/data/BCID_V_rgb_pos.png\" style=\"float: right;width: 150px;\"/>')
   });
</script>
---
...
if (params$table_format == "html"){
  t_q7 <- much_below_normal_tbl %>%
    ...
    dplyr::mutate(`Percentile Category - Last 24 Hour Discharge` = cell_spec(`Percentile Category - Last 24 Hour Discharge`, "html",
                                            color = ifelse(`Percentile Category - Last 24 Hour Discharge`  == "Low", "#F90010",
    ...
    dplyr::mutate(`Percentile Category - 7 Day Discharge` = cell_spec(`Percentile Category - 7 Day Discharge`, "html",
                                            color = ifelse(`Percentile Category - 7 Day Discharge`  == "Low", "#F90010",
