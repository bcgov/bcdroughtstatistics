  ...
  watertemp %>%
    dplyr::mutate(`Station Name` = cell_spec(
      `Station Name`, "html", link = ifelse(nchar(ID)==7,
                                            ...
                                            paste0("https://aqrt.nrs.gov.bc.ca/Data/DataSet/Chart/Location/", ID, "/DataSet/TW/Telemetry/Interval/Latest")))) %>%    dplyr::mutate(`Mean Max Daily Temp (last 7 days; deg C)` = cell_spec(`Mean Max Daily Temp (last 7 days; deg C)`, "html", 
