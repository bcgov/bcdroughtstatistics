...
spdf_select <- drought %>% 
  filter(Drought_Region == params$region) %>% 
  st_simplify(dTolerance = 750)
...
if (params$region == "South Coast Natural Resource Region"){
  sc_stns <- c("08MG0002", "08MG0005", "08MH0041","08GA0005","08GB0001", 
               "08MH0051", "08MH0055", "08MH0058", "08MH0060")
  aq_temps <- bcdroughtstatistics::water_temp_aquarius(station_wt = sc_stns, as_drought_stats = TRUE)
